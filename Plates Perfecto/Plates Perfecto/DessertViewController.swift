...
class DessertViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://api.spoonacular.com/recipes/complexSearch?apiKey=199d83626fa74e18a66f0ccb2eee9f6b&type=dessert&number=30&addRecipeInformation=true&addRecipeNutrition=true")!
